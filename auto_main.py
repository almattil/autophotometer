...
# drawing fits image and markers
	...
	#plt.scatter(ss.ra_susp, ss.dec_susp, 100, marker='s', facecolors='none', edgecolors='m', transform=ax.get_transform('fk5'), label = "large/small fwhm")
	plt.scatter(ra, dec, 100, marker='s', facecolors='none', edgecolors='r', transform=ax.get_transform('fk5'), label = "stars")
	plt.scatter(nonps_ra,nonps_dec, marker='D', facecolors='none', edgecolors='c', transform=ax.get_transform('fk5'))
